...
public class MinimaxAgent extends ChessAgent
{
	...
	private class MinimaxSearcher extends Object implements Callable<Pair<Move, Long> >
	{
		...
		public MinimaxSearcher(DFSTreeNode rootNode, int maxDepth, Stack<Pair<Move, Game>> history)
		{
	...
	protected Move getChessMove(StateView state)
	{
		...
		MinimaxSearcher searcherObject = new MinimaxSearcher(rootNode, this.getMaxDepth(), this.getHistory()); // this obj will run in the background
